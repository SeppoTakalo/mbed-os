...
extern "C" {
int equeue_create(equeue_t *queue, size_t size) { return 0; }
int equeue_create_inplace(equeue_t *queue, size_t size, void *buffer) { return 0; }
int equeue_call(equeue_t *queue, void (*cb)(void *), void *data) { return 0; }
int equeue_call_in(equeue_t *queue, int ms, void (*cb)(void *), void *data) { return 0; }
int equeue_call_every(equeue_t *queue, int ms, void (*cb)(void *), void *data) { return 0; }
int equeue_post(equeue_t *queue, void (*cb)(void *), void *event) { return 0; }
int equeue_timeleft(equeue_t *q, int id) { return 0; }
void *equeue_alloc(equeue_t *queue, size_t size) { return NULL; }
...
void equeue_background(equeue_t *queue, void (*update)(void *timer, int ms), void *timer) {}
void equeue_chain(equeue_t *queue, equeue_t *target) {}

}

events::EventQueue *mbed::mbed_event_queue() {return NULL;}
